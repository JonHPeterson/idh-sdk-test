...
from ...models.get_aggregate_samples_response_500 import GetAggregateSamplesResponse500
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[GetAggregateSamplesResponse500, TimeSeriesSamplesResponse]]:
    ...
    if response.status_code == 500:
        response_500 = GetAggregateSamplesResponse500.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GetAggregateSamplesResponse500, TimeSeriesSamplesResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[GetAggregateSamplesResponse500, TimeSeriesSamplesResponse]
    """

...
from ...models.get_api_v1_timeseries_samples_response_500 import GetApiV1TimeseriesSamplesResponse500
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[GetApiV1TimeseriesSamplesResponse500, TimeSeriesSamplesResponse]]:
    ...
    if response.status_code == 500:
        response_500 = GetApiV1TimeseriesSamplesResponse500.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GetApiV1TimeseriesSamplesResponse500, TimeSeriesSamplesResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[GetApiV1TimeseriesSamplesResponse500, TimeSeriesSamplesResponse]
    """

...
from ...models.get_api_v1_timeseries_tags_getsamples_response_500 import GetApiV1TimeseriesTagsGetsamplesResponse500
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/timeseries/tags/getsamples",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[GetApiV1TimeseriesTagsGetsamplesResponse500, TimeSeriesSamplesResponse]]:
    ...
    if response.status_code == 500:
        response_500 = GetApiV1TimeseriesTagsGetsamplesResponse500.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GetApiV1TimeseriesTagsGetsamplesResponse500, TimeSeriesSamplesResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[GetApiV1TimeseriesTagsGetsamplesResponse500, TimeSeriesSamplesResponse]
    """

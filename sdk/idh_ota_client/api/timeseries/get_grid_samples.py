...
from ...models.get_grid_samples_response_500 import GetGridSamplesResponse500
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[GetGridSamplesResponse500, TimeSeriesSamplesResponse]]:
    ...
    if response.status_code == 500:
        response_500 = GetGridSamplesResponse500.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GetGridSamplesResponse500, TimeSeriesSamplesResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[GetGridSamplesResponse500, TimeSeriesSamplesResponse]
    """

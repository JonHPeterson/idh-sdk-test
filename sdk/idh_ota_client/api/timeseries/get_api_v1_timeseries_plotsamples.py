...
from ...models.get_api_v1_timeseries_plotsamples_response_500 import GetApiV1TimeseriesPlotsamplesResponse500
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 500:
        response_500 = GetApiV1TimeseriesPlotsamplesResponse500.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Union[GetApiV1TimeseriesPlotsamplesResponse500, TimeSeriesSamplesResponse]
    """

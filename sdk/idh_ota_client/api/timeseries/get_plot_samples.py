...
from ...models.get_plot_samples_response_500 import GetPlotSamplesResponse500
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/timeseries/plotsamples",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[GetPlotSamplesResponse500, TimeSeriesSamplesResponse]]:
    ...
    if response.status_code == 500:
        response_500 = GetPlotSamplesResponse500.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GetPlotSamplesResponse500, TimeSeriesSamplesResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[GetPlotSamplesResponse500, TimeSeriesSamplesResponse]
    """

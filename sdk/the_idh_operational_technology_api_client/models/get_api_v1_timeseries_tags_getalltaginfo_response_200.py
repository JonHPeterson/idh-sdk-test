...
T = TypeVar("T", bound="GetApiV1TimeseriesTagsGetalltaginfoResponse200")


@_attrs_define
class GetApiV1TimeseriesTagsGetalltaginfoResponse200:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        get_api_v1_timeseries_tags_getalltaginfo_response_200 = cls()
        ...
        get_api_v1_timeseries_tags_getalltaginfo_response_200.additional_properties = additional_properties
        return get_api_v1_timeseries_tags_getalltaginfo_response_200

...
from ...models.get_api_v1_timeseries_tags_getgridsamples_response_500 import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/timeseries/tags/getgridsamples",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[GetApiV1TimeseriesTagsGetgridsamplesResponse500, TimeSeriesSamplesResponse]]:
    ...
    if response.status_code == 500:
        response_500 = GetApiV1TimeseriesTagsGetgridsamplesResponse500.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GetApiV1TimeseriesTagsGetgridsamplesResponse500, TimeSeriesSamplesResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r"""Get grid timeseries samples for tags

     Get data for timeseries tags in a grid format (equally spaced samples, interpolated if needed).
    Supports both JSON and binary (MessagePack) formats. For binary, set Accept header to
    \"application/msgpack\"
...
def sync(
    *,
    ...
    Returns:
        Union[GetApiV1TimeseriesTagsGetgridsamplesResponse500, TimeSeriesSamplesResponse]
    """

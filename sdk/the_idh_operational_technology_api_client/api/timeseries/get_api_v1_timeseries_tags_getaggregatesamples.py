...
from ...models.get_api_v1_timeseries_tags_getaggregatesamples_response_500 import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/timeseries/tags/getaggregatesamples",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Optional[Union[GetApiV1TimeseriesTagsGetaggregatesamplesResponse500, TimeSeriesSamplesResponse]]:
    ...
    if response.status_code == 500:
        response_500 = GetApiV1TimeseriesTagsGetaggregatesamplesResponse500.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GetApiV1TimeseriesTagsGetaggregatesamplesResponse500, TimeSeriesSamplesResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[GetApiV1TimeseriesTagsGetaggregatesamplesResponse500, TimeSeriesSamplesResponse]
    """
